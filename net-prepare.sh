...
sleep 7 
apt-get -y install neutron-plugin-ml2  neutron-l3-agent neutron-dhcp-agent
...
password = admin
username = admin
url = http://$ODL_MGNT_IP:8080/controller/nb/v2/neutron
EOF
...
ovs-vsctl set Open_vSwitch $id_ovs other_config={'local_ip'='$NET_DATA_VM_IP'}
